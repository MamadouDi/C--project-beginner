...
string Maoroland::getMaoroland_desc(const int& m_archers, const int& m_spearmen, const int& m_swordsmen, const int& m_soldiers, const int& m_cannon){
    return "\nMaoroland army is made of " + to_string(m_swordsmen) +" swordsmen, " + to_string(m_archers)+" archers, "+ to_string(m_spearmen)+" spearmen. Which is a total of "+ to_string(m_soldiers)+" soldiers.Moreover, Maoraland has a total of "+ to_string(m_cannon)+" of cannon.";
...
string Gerarldberg::getGerarldberg_desc(const int& g_archers, const int& g_spearmen, const int& g_swordsmen, const int& g_soldiers, const int& g_cannon){
    return "\nAs for Gerarldberg, it has an army of " + to_string(g_swordsmen) +" swordsmen, " + to_string(g_archers)+" archers, "+ to_string(g_spearmen)+" spearmen. Which is a total of "+ to_string(g_soldiers)+" soldiers.Moreover, Gerarldberg has a total of "+ to_string(g_cannon)+" of cannon.";
    
}

// to_string   to turn into string